...
// Task definition
  case class Task(
      ...
      parameters: Map[
        String,
        String
      ], // Changed from Any to String for JSON codec compatibility
      retries: Int = 0,
      maxRetries: Int = 3,
...
// Workflow definition
  case class Workflow(
      ...
      variables: Map[String, String] =
        Map.empty // Changed from Any to String for JSON codec compatibility
  ) extends Metadata

// Task result
  case class TaskResult(
      taskId: ID,
      output: String, // Changed from Any to String for JSON codec compatibility
...
// TaskDefinition for creating task templates
  case class TaskDefinition(
      ...
      parameterTypes: Map[
        String,
        String
      ], // Changed from Class[_] to String for JSON codec compatibility
      maxRetries: Int = 3,
