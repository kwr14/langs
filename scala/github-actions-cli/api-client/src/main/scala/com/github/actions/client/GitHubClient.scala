...
/** Algebra defining GitHub API operations for workflow runs.
  ...
  * Actions API, enabling testability through dependency injection and
  * allowing for multiple implementations (real HTTP client, mock, etc.).
  */
trait GitHubClient[F[_]]:
  ...
  /** List workflow runs for a repository.
    ...
    * @return List of workflow runs matching the filter
    */
...
object GitHubClient:
  /** Configuration for GitHub API client.
    ...
    * @param baseUri Base URI for GitHub API (default: https://api.github.com)
  ...
  /** Rate limit information from GitHub API headers.
    *
    * @param limit Maximum number of requests per hour
  ...
  /** GitHub API error response.
    ...
    * @param documentationUrl Optional link to documentation
    */
